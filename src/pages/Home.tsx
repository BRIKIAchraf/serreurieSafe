...
import { Shield, Clock, Phone, Star, ArrowRight, CheckCircle, Zap, Award, Users } from 'lucide-react';
  ...
  const services = [
    {
      ...
      description: 'Intervention rapide sans dégâts pour tous types de serrures',
      icon: '🔓',
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <MagneticButton
                  ...
                  className="inline-flex items-center justify-center space-x-2 bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded-lg font-semibold text-lg transition-all duration-200 hover:shadow-lg"
                ...
                <Link
                  to="/services"
                  className="inline-flex items-center justify-center space-x-2 border-2 border-gray-300 hover:border-blue-600 text-gray-700 hover:text-blue-600 px-8 py-4 rounded-lg font-semibold text-lg transition-all duration-200"
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                ...
                <div className="absolute top-6 left-6 bg-white/95 backdrop-blur-sm rounded-lg p-4 shadow-lg">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <div className="font-semibold text-gray-900">Certifié A2P</div>
                      <div className="text-sm text-gray-600">Sécurité garantie</div>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <ScrollReveal className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-6">
              Zone d'<span className="bg-gradient-to-r from-orange-500 to-red-500 bg-clip-text text-transparent">intervention</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <ScrollReveal className="relative z-10 text-center text-white">
            ...
            <p className="text-xl mb-12 max-w-3xl mx-auto opacity-90">
              Notre équipe d'experts est disponible 24h/24 et 7j/7 pour répondre à tous vos besoins de serrurerie. 
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
              <MagneticButton
                href="tel:+33123456789"
                className="inline-flex items-center space-x-2 bg-white text-gray-900 px-10 py-4 rounded-lg font-bold text-xl hover:bg-gray-100 transition-all duration-200 hover:shadow-lg"
              >
              ...
              <Link
                to="/emergency"
                className="inline-flex items-center space-x-2 border-2 border-white text-white px-10 py-4 rounded-lg font-bold text-xl hover:bg-white hover:text-gray-900 transition-all duration-200"
              >
            ...
            <div className="mt-12 text-center">
              <p className="text-gray-300 text-lg">
                ⚡ Intervention en moins de 30 minutes • 🛡️ Devis gratuit • ✅ Satisfaction garantie
              </p>
            </div>
          </ScrollReveal>
        </div>
