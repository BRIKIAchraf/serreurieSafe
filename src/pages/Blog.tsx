...
const Blog: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 via-gray-950 to-black text-white relative overflow-hidden">
      ...
      {/* === FILTRES === */}
      <section className="py-12 flex flex-wrap justify-center gap-3 px-6 relative z-20">
        {categories.map((cat) => (
          <motion.button
            key={cat}
      ...
      {/* === LIGNE VERTICALE ANIMÉE (TIMELINE) === */}
      <motion.div
        initial={{ height: 0 }}
      ...
      {/* === SECTION MAGAZINE === */}
      <section className="space-y-24 max-w-6xl mx-auto px-6 py-20 relative z-10">
        {filteredPosts.map((post, i) => (
          ...
          >
            ...
            <div className="flex-1 space-y-4">
              <h2 className="text-3xl font-bold leading-snug text-white hover:text-orange-400 transition-colors">
      ...
      {/* === CTA === */}
      <section className="py-32 text-center bg-gradient-to-b from-black/40 via-transparent to-transparent relative">
        <div className="absolute inset-0 bg-gradient-to-r from-orange-500/10 via-red-500/10 to-transparent blur-3xl" />
        <div className="relative max-w-3xl mx-auto px-6">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <input
              ...
              className="px-6 py-4 rounded-full flex-1 bg-white/20 border border-white/30 focus:border-orange-500 focus:outline-none text-white placeholder-gray-300"
            />
